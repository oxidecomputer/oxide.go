		...
		},
		{
			...
			wantTypes: []TypeTemplate{
				...
				{Description: "// IntOrStringType is the type definition for a IntOrStringType.", Name: "IntOrStringType", Type: "string"},
				{
					...
					Name:            "IntOrStringInt",
					Type:            "struct",
					Fields:          []TypeField{{Name: "Value", Type: "*int", MarshalKey: "value", OmitDirective: "omitzero"}},
					OneOfMarker:     "isIntOrStringVariant",
				...
				},
				{
					...
					Type:            "struct",
					Fields:          []TypeField{{Name: "Value", Type: "string", MarshalKey: "value", OmitDirective: "omitzero"}},
					OneOfMarker:     "isIntOrStringVariant",
					OneOfMarkerType: "intOrStringVariant",
				},
				{
					...
					OneOfVariants: []OneOfVariant{
						{DiscriminatorValue: "int", DiscriminatorEnumValue: "Int", TypeName: "IntOrStringInt"},
