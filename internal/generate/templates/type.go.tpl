...
func (v {{.Name}}) {{.OneOfDiscriminatorMethod}}() {{.OneOfDiscriminatorType}} {
	switch v.{{- range .Fields}}{{- if eq .MarshalKey $.OneOfValueField}}{{.Name}}{{- end}}{{- end}}.(type) {
	{{- range .OneOfVariants}}
	case *{{.TypeName}}:
...
func (v *{{.Name}}) UnmarshalJSON(data []byte) error {
	...
	v.{{- range .Fields}}{{- if eq .MarshalKey $.OneOfValueField}}{{.Name}}{{- end}}{{- end}} = value
	return nil
}
...
func (v {{.Name}}) MarshalJSON() ([]byte, error) {
	...
	if v.{{- range .Fields}}{{- if eq .MarshalKey $.OneOfValueField}}{{.Name}}{{- end}}{{- end}} != nil {
		valueBytes, err := json.Marshal(v.{{- range .Fields}}{{- if eq .MarshalKey $.OneOfValueField}}{{.Name}}{{- end}}{{- end}})
		if err != nil {
			return nil, err
		}
